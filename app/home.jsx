          ...
          {sent ? (
            ...
            <form onSubmit={submitLead} style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-base)' }}>
              ...
              <label style={{ display: 'flex', alignItems: 'flex-start', gap: 12, marginTop: 'var(--space-xs)', cursor: 'pointer', padding: '6px 0' }}>
                ...
                <span style={{ fontFamily: 'var(--font-body)', fontSize: 'var(--type-body-sm-size)', lineHeight: 1.55, color: 'var(--color-body)' }}>{CB_CONSENT_TEXT}{' '}<a href="Privacy.html" style={{ color: 'var(--color-ink)', textDecoration: 'underline', textUnderlineOffset: 2 }}>Privacy Policy</a></span>
              </label>
