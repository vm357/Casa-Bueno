/* Casa Bueno — Terms of Service. Content generated with Termly, re-typeset in the
 * site's design language. Update the "Last updated" date whenever Termly reissues. */

const { NavBar, Footer, Eyebrow } = window;

const CB_TERMS_UPDATED = 'August 7, 2026';
const CB_T_EMAIL = 'vanessasellsnj1@gmail.com';
...
function TMail() { return <a href={'mailto:' + CB_T_EMAIL}>{CB_T_EMAIL}</a>; }
function TH({ id, n, children }) { return <h2 id={id}><span className="cb-h-num">{n}</span>{children}</h2>; }
  ...
  return (
    <section className="cb-legal-hero">
      ...
      <div className="cb-legal-hero-inner">
        ...
        <p className="cb-legal-sub">Last updated {CB_TERMS_UPDATED}</p>
      </div>
    </section>
  );
}
    ...
    <React.Fragment>
      ...
      <main id="cb-main" className="cb-legal">
        <div className="cb-legal-body">
          ...
          <p>We are Casa Bueno Group (“<strong>Company</strong>,” “<strong>we</strong>,” “<strong>us</strong>,” “<strong>our</strong>”), a company registered in New Jersey, United States at 151 Forest St, Unit H, Montclair, NJ 07042.</p>
          <p>We operate the website <a href="https://sellwithbueno.com" target="_blank" rel="noopener noreferrer">https://sellwithbueno.com</a> (the “<strong>Site</strong>”), as well as any other related products and services that refer or link to these legal terms (the “<strong>Legal Terms</strong>”) (collectively, the “<strong>Services</strong>”).</p>
          <p>Provides professional residential real estate services, assisting clients with buying, selling, and finding properties. Services may include property searches, listing and marketing services, buyer and seller consultations, property showings, negotiations, and guidance throughout the real estate transaction process.</p>
          <p>You can contact us by phone at <a href="tel:+17326313267">7326313267</a>, email at <TMail />, or by mail to 151 Forest St, Unit H, Montclair, NJ 07042, United States.</p>
          <p>These Legal Terms constitute a legally binding agreement made between you, whether personally or on behalf of an entity (“<strong>you</strong>”), and Casa Bueno Group, concerning your access to and use of the Services. You agree that by accessing the Services, you have read, understood, and agreed to be bound by all of these Legal Terms. IF YOU DO NOT AGREE WITH ALL OF THESE LEGAL TERMS, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SERVICES AND YOU MUST DISCONTINUE USE IMMEDIATELY.</p>
          ...
          <nav id="toc" className="cb-toc">
            ...
            <ol>{T_TOC.map(([id, label]) => <li key={id}><a href={'#' + id}>{label}</a></li>)}</ol>
          </nav>

          <TH id="services" n="1">Our services</TH>
          ...
          <TH id="ip" n="2">Intellectual property rights</TH>
          ...
          <p>If you wish to make any use of the Services, Content, or Marks other than as set out in this section or elsewhere in our Legal Terms, please address your request to: <TMail />. If we ever grant you the permission to post, reproduce, or publicly display any part of our Services or Content, you must identify us as the owners or licensors of the Services, Content, or Marks and ensure that any copyright or proprietary notice appears or is visible on posting, reproducing, or displaying our Content.</p>
          ...
          <TH id="userreps" n="3">User representations</TH>
          ...
          <TH id="prohibited" n="4">Prohibited activities</TH>
          <p>You may not access or use the Services for any purpose other than that for which we make the Services available. The Services may not be used in connection with any commercial endeavors except those that are specifically endorsed or approved by us.</p>
          <p>As a user of the Services, you agree not to:</p>
          <ul>{PROHIBITED.map((p, i) => <li key={i}>{p}</li>)}</ul>

          <TH id="ugc" n="5">User generated contributions</TH>
          ...
          <ul>{UGC_WARRANTS.map((p, i) => <li key={i}>{p}</li>)}</ul>
          ...
          <TH id="license" n="6">Contribution license</TH>
          ...
          <TH id="reviews" n="7">Guidelines for reviews</TH>
          ...
          <TH id="thirdparty" n="8">Third-party websites and content</TH>
          ...
          <TH id="sitemanage" n="9">Services management</TH>
          ...
          <TH id="ppyes" n="10">Privacy policy</TH>
          <p>We care about data privacy and security. Please review our Privacy Policy: <strong><a href="Privacy.html">Privacy Policy</a></strong>. By using the Services, you agree to be bound by our Privacy Policy, which is incorporated into these Legal Terms. Please be advised the Services are hosted in the United States. If you access the Services from any other region of the world with laws or other requirements governing personal data collection, use, or disclosure that differ from applicable laws in the United States, then through your continued use of the Services, you are transferring your data to the United States, and you expressly consent to have your data transferred to and processed in the United States.</p>

          <TH id="copyrightyes" n="11">Copyright infringements</TH>
          ...
          <TH id="terms" n="12">Term and termination</TH>
          ...
          <TH id="modifications" n="13">Modifications and interruptions</TH>
          ...
          <TH id="law" n="14">Governing law</TH>
          ...
          <TH id="disputes" n="15">Dispute resolution</TH>
          ...
          <p>If for any reason, a Dispute proceeds in court rather than arbitration, the Dispute shall be commenced or prosecuted in the state and federal courts located in Somerset County, New Jersey, and the Parties hereby consent to, and waive all defenses of lack of personal jurisdiction, and forum non conveniens with respect to venue and jurisdiction in such state and federal courts. Application of the United Nations Convention on Contracts for the International Sale of Goods and the Uniform Computer Information Transaction Act (UCITA) are excluded from these Legal Terms.</p>
          ...
          <TH id="corrections" n="16">Corrections</TH>
          <p>There may be information on the Services that contains typographical errors, inaccuracies, or omissions, including descriptions, pricing, availability, and various other information. We reserve the right to correct any errors, inaccuracies, or omissions and to change or update the information on the Services at any time, without prior notice.</p>

          <TH id="disclaimer" n="17">Disclaimer</TH>
          ...
          <TH id="liability" n="18">Limitations of liability</TH>
          ...
          <TH id="indemnification" n="19">Indemnification</TH>
          ...
          <TH id="userdata" n="20">User data</TH>
          <p>We will maintain certain data that you transmit to the Services for the purpose of managing the performance of the Services, as well as data relating to your use of the Services. Although we perform regular routine backups of data, you are solely responsible for all data that you transmit or that relates to any activity you have undertaken using the Services. You agree that we shall have no liability to you for any loss or corruption of any such data, and you hereby waive any right of action against us arising from any such loss or corruption of such data.</p>

          <TH id="electronic" n="21">Electronic communications, transactions, and signatures</TH>
          ...
          <TH id="sms" n="22">SMS text messaging</TH>
          <h3>Program Description</h3>
          <p>By opting into any Follow Up Boss text messaging program, you expressly consent to receive text messages (SMS) to your mobile number. Follow Up Boss text messages may include: responses to inquiries, appointment confirmations, reminders, and notifications of schedule updates or important changes.</p>
          <h3>Opting Out</h3>
          ...
          <h3>Support</h3>
          <p>If you have any questions or need assistance regarding our SMS communications, please reply with the keyword HELP. You can also email us at <TMail /> or call at <a href="tel:+17326313267">7326313267</a>. If you have any questions regarding privacy, please read our Privacy Policy: <a href="Privacy.html">Privacy Policy</a>.</p>
          <p>By using this Website, you agree to the practices described in our <a href="Privacy.html">Privacy Policy</a>.</p>

          <TH id="california" n="23">California users and residents</TH>
          <p>If any complaint with us is not satisfactorily resolved, you can contact the Complaint Assistance Unit of the Division of Consumer Services of the California Department of Consumer Affairs in writing at 1625 North Market Blvd., Suite N 112, Sacramento, California 95834 or by telephone at (800) 952-5210 or (916) 445-1254.</p>

          <TH id="misc" n="24">Miscellaneous</TH>
          ...
          <TH id="contact" n="25">Contact us</TH>
          <p>In order to resolve a complaint regarding the Services or to receive further information regarding use of the Services, please contact us at:</p>
          <address className="cb-address">Casa Bueno Group<br />151 Forest St, Unit H<br />Montclair, NJ 07042<br />United States<br />Phone: <a href="tel:+17326313267">7326313267</a><br /><TMail /></address>
        </div>
      </main>
      <Footer />
    </React.Fragment>
...
ReactDOM.createRoot(document.getElementById('cb-root')).render(<TermsPage />);
