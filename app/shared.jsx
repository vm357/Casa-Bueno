...
function PageBloom({ hue = 'mint', x = '85%', y = '10%', size = 620, opacity = 0.55, blur = 40, drift = false }) {
  return <div aria-hidden className={'cb-bloom' + (drift ? ' cb-bloom--' + (drift === 'alt' ? 'drift-alt' : 'drift') : '')} style={{
